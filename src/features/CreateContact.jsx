    ...
    <div className='flex flex-col justify-center  mr-4 w-full'>
      <div className="flex flex-col p-10 md: p-3 justify-center w-full items-center" >
        ...
        <form className="flex text-center md:flex-col items-center justify-center" >
          ...
          <input onChange={firstNameChange} type="text" className="shadow appearance-none border border-blue-500 rounded w-xl py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline " maxlength="10" />
          <label className="mr-1 ml-1">Last Name</label>
          <input onChange={lastNameChange} type="text" className=" shadow appearance-none border border-blue-500 rounded w-xl py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" maxlength="10" />
        </form>
